...
class Setup(object):
    ...
    def __init_ui(self):
        ...
        self.__checkbutton_use_global_ime = self.__builder.get_object("checkbutton_use_global_ime")
        self.__checkbutton_use_global_ime.set_active(
            self.__config.get_value("general", "use_global_ime", False))
        self.__checkbutton_use_global_ime.connect("toggled", self.__checkbutton_use_global_ime_toggled_cb)
    ...
    def __checkbutton_use_global_ime_toggled_cb(self, button):
        value = self.__checkbutton_use_global_ime.get_active()
        self.__config.set_value("general", "use_global_ime", value)
